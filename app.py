...
<div class="bio-text">
    ...
    postdoctoral research at <b>SUNY, Stony Brook</b>. I then served as an
    <b>Assistant Professor</b> at Northern Illinois University's College of Engineering,
    teaching courses across Electrical and Industrial Engineering for over <b>15 years</b>.
    <hr class="bio-divider"/>
    Five years ago I transitioned into <b>AI & Data Science</b>, working at
    <b>Discover Financial Services</b> and now <b>Capital One</b>. My work spans
    Generative AI, Audio-to-Speech Recognition, and Responsible AI — including
    leading Guardrail development for an enterprise AI Engineering platform.
    <hr class="bio-divider"/>
    I am deeply passionate about <b>AI, GenAI, and Agentic AI</b>. I actively mentor
    working professionals in the <b>AIML & AIDL programs</b> at Great Learning and the
    University of Texas at Austin.
</div>
<br/>
<div class="bio-stat"><span class="bio-stat-num">350+</span><span class="bio-stat-label">professionals mentored</span></div>
<div class="bio-stat"><span class="bio-stat-num">400+</span><span class="bio-stat-label">hours of AI/ML teaching</span></div>
<div class="bio-stat"><span class="bio-stat-num">4.75–5</span><span class="bio-stat-label">mentor rating (4 years)</span></div>
<hr class="bio-divider"/>
""", unsafe_allow_html=True)
