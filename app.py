...
if headshot_path.exists():
    ...
    avatar_tag = f'<img class="bio-avatar" src="{hs_src}" alt="Dr. Suma Rajashankar"/>'
    headshot_main = f'<img src="{hs_src}" alt="Dr. Suma Rajashankar" style="width:160px;height:160px;border-radius:50%;object-fit:cover;border:3px solid #c9a96e;display:block;margin:0 auto 0.8rem;box-shadow:0 0 24px rgba(201,169,110,0.3);"/>'
else:
    avatar_tag = '<div class="bio-avatar-placeholder">SR</div>'
    headshot_main = '<div style="width:160px;height:160px;border-radius:50%;background:#1e1e1e;border:2px solid #c9a96e;display:flex;align-items:center;justify-content:center;font-family:Cormorant Garamond,serif;font-size:2.5rem;color:#c9a96e;margin:0 auto 0.8rem;">SR</div>'
...
# ── Centered headshot + title on main page ─────────────────────────────────────
st.markdown(f"""
<div style="text-align:center; padding: 1.5rem 0 0.5rem;">
    {headshot_main}
    <div style="font-family:'Cormorant Garamond',serif; font-size:1.5rem; font-weight:600; color:#e8e0d4; margin-bottom:0.2rem;">
        Dr. Suma Rajashankar
    </div>
    <div style="font-size:0.88rem; color:#c9a96e; letter-spacing:0.8px; text-transform:uppercase;">
...
<div class="quote-block">
    ...
    <div style="font-size:1.05rem; color:#c9a96e; font-style:italic; font-family:'Cormorant Garamond',serif; letter-spacing:0.5px; margin-top:0.5rem;">
